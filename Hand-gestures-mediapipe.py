...
def main():
    ...
    result = cv.VideoWriter('Output.avi', cv.VideoWriter_fourcc(*'MJPG'), 10, size)
    ...
    while True:
        ...
        result.write(debug_image)

        cv.putText(debug_image, 'Press ESC to Quit ', (3, 70), cv.FONT_HERSHEY_SIMPLEX, 1,
